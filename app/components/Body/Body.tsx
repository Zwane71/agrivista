...
const Body = () => {
	return (
		<div className='bg-[rgb(240,240,240)] w-full py-8'>
			<div className='flex flex-col sm:flex-row md:flex-col lg:flex-row mx-4 sm:mx-3 md:mx-6 lg:mx-10 p-4 sm:p-2 md:p-4 lg:p-10'>
				...
				<div className='relative flex-1 mt-4 lg:mt-0  '>
					<div className='relative w-full h-full sm:pb-[35%] md:pb-[75.23%] lg:pb-[85.12%] xl:pb-[90.9%]'>
						<Image
							src='/field.png'
							alt='field'
						...
						<h1 className=' absolute top-1/2 left-1/2 transform -translate-x-1/2 translate-y-1/4 font-montserrat sm:text-[10px] md:text-[18px] lg:text-[27px] xl:text-[36px] font-bold bg-white p-2 sm:p-2.5 md:p-3 lg:p-3.5 xl:p-11 rounded-md sm:rounded-[7.5px] md:rounded-[15px] lg:rounded-[22.4px] xl:rounded-[30px] w-[20px] sm:w-[40px] md:w-[60px] lg:w-[80px] xl:w-96 text-[rgb(32,78,81)] text-center'>
							Since 1976
						</h1>
					</div>
				</div>
